...
* **__load_completion:** load in-tree before system data dirs ([c7d526d](https://github.com/scop/bash-completion/commit/c7d526d36ce6d92294d50c2c17ee995bb8d4c364))
* **__load_completion:** look more places for completion files ([12cff41](https://github.com/scop/bash-completion/commit/12cff4118993bb6614cc7acd893ca0e90d430c4b))
* **_comp_expand_glob:** add utility to safely expand pathnames ([28c4ed9](https://github.com/scop/bash-completion/commit/28c4ed9cc9d9d4f2f83fd1d592c41d4273f0ef85))
* **_comp_looks_like_path:** new utility, use it ([f2b0511](https://github.com/scop/bash-completion/commit/f2b05116d76b353da990a38eef2be54ecc2a5519))
* **_comp_split:** add a function to split a string into an array ([86dbf21](https://github.com/scop/bash-completion/commit/86dbf21634d34f3d91502f7348652b45e472552f))
* **_modules:** support zstd compressed modules ([4298bc2](https://github.com/scop/bash-completion/commit/4298bc2760d00c83025680f11a3490403b91ba98))
* **7z:** complete 7zr and 7zz ([90bacf1](https://github.com/scop/bash-completion/commit/90bacf112ecfee801251eff771d8c26f276efd3f))
* **7z:** complete 7zzs ([c9e9720](https://github.com/scop/bash-completion/commit/c9e97203cbc43f06ed17f126205b9b636f11e79b))
* **7z:** complete h i and rn commands ([7a72e43](https://github.com/scop/bash-completion/commit/7a72e435fa6bb4f561ed6cfceea7a19406f3ceef))
...
* **alias:** add option completion support ([3ae8462](https://github.com/scop/bash-completion/commit/3ae8462f1823a117ea67dc4584eeb5819c845904))
* **bash_completion:** add a utility `_comp_deprecate_func` ([52244e6](https://github.com/scop/bash-completion/commit/52244e6718f2c598b17663cbfccd8d311a96048d))
* **bash_completion:** add a utility `_comp_xfunc` ([c9faaee](https://github.com/scop/bash-completion/commit/c9faaeebc2d0ab173f728416c7658a589f96d089))
* **cd,pushd:** add option completion support ([5052702](https://github.com/scop/bash-completion/commit/505270250c89bfb6920bb4ef860b40c14d68f7cd))
* **evince:** complete on XPS and more comic book documents ([28cf08f](https://github.com/scop/bash-completion/commit/28cf08fcc09aaf15cb7b7ac50873fc6e39e90c16))
* **feh:** complete on WebP images ([a66ae99](https://github.com/scop/bash-completion/commit/a66ae9963939f23f885bdbed9f373a5b6d4232a0))
* **file-roller:** associate with zstd compressed files ([fd7eadc](https://github.com/scop/bash-completion/commit/fd7eadc541ef15fdb897911613d6939bcc1bb742))
* **fio:** complete `*.fio` as job files, too ([295ce25](https://github.com/scop/bash-completion/commit/295ce25d78ba0e725ac3f5357a643b283092d1f9))
* **fio:** include `5` in `--terse-version` completions ([317133b](https://github.com/scop/bash-completion/commit/317133b434714029cfd272f80b1e216122cb9a25))
* **fio:** more option and arg completions ([#805](https://github.com/scop/bash-completion/issues/805)) ([eefef44](https://github.com/scop/bash-completion/commit/eefef4474e9f13bae83f6d83f75b7903cfeca2d3))
* **fio:** update --crctest, --debug, and --terse-version arg completion ([c00d3df](https://github.com/scop/bash-completion/commit/c00d3dff7d2880495f78459210eb5b4f7d4764a1))
* **firefox:** Add svg file completion ([65665c2](https://github.com/scop/bash-completion/commit/65665c25121f18b07504a33d7f6b12c7485e77ea))
* **gpg,gpg2:** more key option argument completions ([ba3b8eb](https://github.com/scop/bash-completion/commit/ba3b8ebcf5551c4b47df8436a1330b7b595a188d))
* **gpg:** more key option argument completions ([a4deb37](https://github.com/scop/bash-completion/commit/a4deb37c07ca46e816c153a80596428cfbb1496e))
* **gpg:** recognize `--clear-sign` ([eb2fcac](https://github.com/scop/bash-completion/commit/eb2fcac110633d359d9bb0241c2483ea2b69e03d))
* **help:** support options, improve quoting ([01d2fad](https://github.com/scop/bash-completion/commit/01d2fadc94fd0a359955e33e9a9b8abc872f522a))
* **insmod,modinfo,modprobe:** support zstd compressed modules ([#614](https://github.com/scop/bash-completion/issues/614)) ([b6a9ed5](https://github.com/scop/bash-completion/commit/b6a9ed50909224fa6b7887b604e86e4efce8289b))
* **iperf*:** scrape `--format` completions from `--help` ([27c694f](https://github.com/scop/bash-completion/commit/27c694feaea266628c83e2bf0aec58ffd4d64623))
* **iperf3:** add more option arg (non-)completions ([2596626](https://github.com/scop/bash-completion/commit/2596626b00891e65600b540038e736d400d6d69a))
* **ip:** make option parsing work with busybox ip ([4eb5222](https://github.com/scop/bash-completion/commit/4eb5222a6c374f09e6e5bd16216c63686f9be82c))
* **ip:** more option arg (non-)completions ([#828](https://github.com/scop/bash-completion/issues/828)) ([5297161](https://github.com/scop/bash-completion/commit/5297161b3d4a3db9982c386611c6d005575268ca))
* **jq:** associate with *.jsonl ([#863](https://github.com/scop/bash-completion/issues/863)) ([d460505](https://github.com/scop/bash-completion/commit/d46050505749bf045958e1f95f3f9ef2372cc51b))
* **kill:** add `-n` arg non-completion ([be4d134](https://github.com/scop/bash-completion/commit/be4d13415ed15b4b054e13e41497a196bce98bb0))
* **lrzip:** complete long option args ([8a4a499](https://github.com/scop/bash-completion/commit/8a4a499f03244cad999b50a96add4ec6150d4625))
* **man:** allow arbitrary lowercase ASCII post-numeric-section suffixes ([6f69ac0](https://github.com/scop/bash-completion/commit/6f69ac0e874053b52929a56ca8bb15d51f9102e0))
* **man:** support zstd compressed man pages ([9770123](https://github.com/scop/bash-completion/commit/9770123c3aaec070034bdafb49324af3fd0f9f44))
* **okular:** complete with markdown files ([93c3d02](https://github.com/scop/bash-completion/commit/93c3d02d619561687779430d768a7719469272f0))
* **openssl:** recognize `storeutl` ([#867](https://github.com/scop/bash-completion/issues/867)) ([8490bf8](https://github.com/scop/bash-completion/commit/8490bf806a86a7960f0b9a14e16421ea7bd05ef5))
* **pigz:** add more option argument non-completions ([#806](https://github.com/scop/bash-completion/issues/806)) ([0f055e5](https://github.com/scop/bash-completion/commit/0f055e517c3229f19193bcc295a5481bf08df675))
* **pylint:** message ids completion ([75a38ca](https://github.com/scop/bash-completion/commit/75a38cabc7142494fe2a4ae9ffc986124a94ef8f))
* **pyston,pyston3:** new completion, python alias ([e45c45e](https://github.com/scop/bash-completion/commit/e45c45e6fa907bfa5ebd3793b896e37805a1ebd2))
* **python,pyvenv:** 3.11 support ([1aa6111](https://github.com/scop/bash-completion/commit/1aa61111956139cc48276a4c1a8bb308d5cc94f7))
* **python:** complete with *.zip ([386bc5e](https://github.com/scop/bash-completion/commit/386bc5eb806222a505709ea142f6dd0bff024421))
...
* **reportbug:** parse various option args from option help ([dea48ff](https://github.com/scop/bash-completion/commit/dea48ff7bc9189d4352adf74f7b2783c323c636f))
* set up drill to be completed by _known_hosts ([cbec56c](https://github.com/scop/bash-completion/commit/cbec56cfd54393fe2cee320c17bbe94510fa0a51))
* **sqlite3:** add -maxsize arg non-completion ([222c710](https://github.com/scop/bash-completion/commit/222c710872abd1351d1fde8cf09c14378b51a455))
* **ssh-keygen:** sync -O options with openssh 8.4p1, FIDO arg fixes ([#674](https://github.com/scop/bash-completion/issues/674)) ([521348d](https://github.com/scop/bash-completion/commit/521348d0a03e961043a2aa64911f2f048e0469b2))
* **ssh:** add -B arg completion ([c32358b](https://github.com/scop/bash-completion/commit/c32358bda69909cdf4957489a5b8944af946575d))
* **tar:** associate with *.xbps (Void Linux package) ([5b842ff](https://github.com/scop/bash-completion/commit/5b842ff96de16b0e04305f823c3966eaac3a98f0))
* **tree:** new completion ([2059ac8](https://github.com/scop/bash-completion/commit/2059ac8fd04970f210a6461de383ca53c5ad2ff5))
* **tree:** support long option args separated by equals sign ([1fa691a](https://github.com/scop/bash-completion/commit/1fa691ace1cff474b71a0bb1d0384eda19dcd8b0))
* **truncate:** new completion ([9b535a1](https://github.com/scop/bash-completion/commit/9b535a12460e030047deb436236c76dd65a07a74))
* **xdg-mime:** complete MIME types from system MIME dir contents ([097a402](https://github.com/scop/bash-completion/commit/097a402bf7a730d3a049e81275e4fa7ba3d714d1))
* **xmlwf:** add -a and -b arg non-completions ([3e55711](https://github.com/scop/bash-completion/commit/3e55711e3929f7a762a9e108858e77b4f34745f4))


### Bug Fixes

* **__load_completion:** do not warn when completing `.` first time ([017fb55](https://github.com/scop/bash-completion/commit/017fb55cab7b0d611b025ef47941df8cb1305741))
* **__load_completion:** lower the precedence of the completion "_cmd" ([1984040](https://github.com/scop/bash-completion/commit/19840401612f23582e819ef277260299151334c6))
* **_command_commnad:** support bash-5.2 quoting in "complete -p" ([08450fa](https://github.com/scop/bash-completion/commit/08450fa8d9df93655f12544c8863d767ba10e9a7))
* **_command_offset:** discard previous results on retries ([befbfc3](https://github.com/scop/bash-completion/commit/befbfc33e41fd73711df33a624befd644b0c088c))
* **_command_offset:** fix completions splitted by spaces ([33dc624](https://github.com/scop/bash-completion/commit/33dc6241d0126e53fa64708a88737c55b94c0729))
* **_command_offset:** handle exit 124 during meta-command completion ([7e68b72](https://github.com/scop/bash-completion/commit/7e68b72af6add620db5c597174897e7f9da35d84))
* **_command_offset:** restrict changes to COMP_* in the local scope ([4f9678e](https://github.com/scop/bash-completion/commit/4f9678e7b57fd38504bf6f26b5b3257a7576b0fa))
* **_command,_command_offset:** missing quotes for command variables ([ae1a164](https://github.com/scop/bash-completion/commit/ae1a164f5a7611b55a1395fafc06d319b4104761))
* **_comp_initialize:** save original completion arguments ([fc4af85](https://github.com/scop/bash-completion/commit/fc4af85896e79625c855ee19a6d0b353ca65c79c))
* **_comp_initialize:** update doc comment ([fbc51c8](https://github.com/scop/bash-completion/commit/fbc51c887e16fcc493d8678ddc2bb620fb16b62e))
* **_expand:** avoid pathname expansions in eval arguments ([0de8dea](https://github.com/scop/bash-completion/commit/0de8dea048ffe09f9855167224b1e7ca4e06a5fd))
* **_get_comp_words_by_ref:** work around localvar_inherit ([9c061e5](https://github.com/scop/bash-completion/commit/9c061e5ffca20c4626913fc2ae7b37540aad302f))
* **_included_ssh_config_files:** fix for failglob ([13464e4](https://github.com/scop/bash-completion/commit/13464e4bc32c9ab8bd0d091fc0b134ccd70c8720))
* **_init_completion:** update redirection pattern ([3bc4376](https://github.com/scop/bash-completion/commit/3bc4376113e75e4c50a6d58cb0fdb76a56c8780b))
* **_known_hosts_real:** document the exact behavior of comp_args ([356c1cb](https://github.com/scop/bash-completion/commit/356c1cbf43e0b311d449f8b691731dca8a709c6e))
* **_known_hosts_real:** exclude directories from the config files ([657bd08](https://github.com/scop/bash-completion/commit/657bd08b00a9c999d11e5bdd5df6243bae2a61eb))
* **_known_hosts_real:** remove empty hostnames ([#737](https://github.com/scop/bash-completion/issues/737)) ([0486a11](https://github.com/scop/bash-completion/commit/0486a11ad5184d2bac8e6c988238e190a0d6cd03))
* **_known_hosts_real:** work around custom IFS ([#829](https://github.com/scop/bash-completion/issues/829)) ([c314aec](https://github.com/scop/bash-completion/commit/c314aeca311a838b3827b01585c45fa31469462b))
* **_ltrim_colon_completions:** do compaction of sparse COMPREPLY ([f2bec27](https://github.com/scop/bash-completion/commit/f2bec2788dcca65a44f7dcd1ca468ab31c26b479))
...
* **_parse_help:** protect word splitting from pathname expansions ([3d70c64](https://github.com/scop/bash-completion/commit/3d70c641c8b43a2adc041cedd5f2fe92ba1fd9fc))
* **_variables:** protect from failglob ([503cf7b](https://github.com/scop/bash-completion/commit/503cf7b7baa7733982111d435225249ca85f00bc))
* **_xinetd_services,aspell,dpkg,etc.:** avoid unnecessary word splitting ([f8220fa](https://github.com/scop/bash-completion/commit/f8220fa05dd4de3bd28a89d1d440b9241c0270b1))
* address shellcheck SC2294 ([1a7684c](https://github.com/scop/bash-completion/commit/1a7684cf794a8623f7ecec5caee9e6224804ef55))
* address shellcheck SC2295 ([38150db](https://github.com/scop/bash-completion/commit/38150dbd9e2b80d6d4f8ce5b3e2e0f15f5ed5c79))
* **apt-mark:** nounset mode error on unknown option ([4ccf000](https://github.com/scop/bash-completion/commit/4ccf000c04ada81e32d6c6bd5e1727c4becb319b))
* **avahi-browse:** nounset mode error on unknown option ([ceb4fdd](https://github.com/scop/bash-completion/commit/ceb4fdd4577055e2aa220e7cc806c60059bac8b7))
* **bash_completion:** support BASH_COMPLETION_COMPAT_IGNORE ([966a4e0](https://github.com/scop/bash-completion/commit/966a4e043822613040546e8c003509798c5fae1a))
* command name variable quoting fixes ([4407656](https://github.com/scop/bash-completion/commit/440765642ae58229bbb210f1b4de1dde856b63db))
* **configure.ac:** bourne sh compatibility ([063765c](https://github.com/scop/bash-completion/commit/063765c3afa6280fff2ddd72c6cd83412f4efa43))
* **contest:** expect "rendered_cmd" but not "cmd" in assert_complete() ([1ccebac](https://github.com/scop/bash-completion/commit/1ccebac35dc03d76a51dc9781a25e630f1c1e709))
* **curl:** nounset mode error on unknown option ([091ad2d](https://github.com/scop/bash-completion/commit/091ad2d2bf06bb015660c8066456800f610c6064))
* cword calculation w/custom wordbreaks and trailing whitespace ([6d14916](https://github.com/scop/bash-completion/commit/6d14916a0cddb8c849f7cd1d9e583f9e6bcd28a9))
* **evince:** don't complete on gzipped XPS docs ([e5ab3ad](https://github.com/scop/bash-completion/commit/e5ab3ad430cb9b1881c514c9b830ad96acfc330b))
* **evince:** remove empty extglob alternation segment ([a79746c](https://github.com/scop/bash-completion/commit/a79746c62917c25a17b4711e3d8527f2b67b0a5c))
* **export:** do not output equals sign for `-f` arg completions ([#779](https://github.com/scop/bash-completion/issues/779)) ([3368d9b](https://github.com/scop/bash-completion/commit/3368d9b9239adc134848c197ec03c91b6283d278))
* **export:** use "_comp_dequote" instead of bare "eval" ([7dd93b7](https://github.com/scop/bash-completion/commit/7dd93b75c534cd6074d76cdf779e8219c0a3c985))
* **function:** remove extra space for non-existing functions ([f45fc77](https://github.com/scop/bash-completion/commit/f45fc7706fc7e5245de9e2b9437ac8abc0f6524d))
* **function:** suppress error messages for non-existent functions ([c343c46](https://github.com/scop/bash-completion/commit/c343c46e8626cf7418a0c6d808c41d8d6fce93b6))
* handle the case of prev=-oOPTARG ([9483503](https://github.com/scop/bash-completion/commit/9483503c09a6daba06b71898293d249356a95e46))
* **help:** install completion iff function definition succeeds ([b9db334](https://github.com/scop/bash-completion/commit/b9db334eded61c1538337b8b8f35919faaa35cc4))
* **ip:** netns list parsing with netnsids included ([a4d4ebc](https://github.com/scop/bash-completion/commit/a4d4ebcbb6c2c4d2ca09ba341d0207f9af880b8f))
* **make,mutt:** fix for "nounset" ([5c4fc14](https://github.com/scop/bash-completion/commit/5c4fc1400e3400a1707ecce097c261d6aa6bf244))
* **make:** deactivate the display-only mode ([5eb1042](https://github.com/scop/bash-completion/commit/5eb1042ffcbbcfa7156e2624ff9c6b626a35c25e))
* **make:** do not strip dirnames for COMP_TYPE=37 (%) and 42 (*) ([a1a94f6](https://github.com/scop/bash-completion/commit/a1a94f60e90e8e0fc87c398136528e8a7b3b73f9))
* **make:** show unique targets in subdirs ([1ea3326](https://github.com/scop/bash-completion/commit/1ea3326e67ae44e3eb46d8501007f27f4b26f2e6))
* **make:** use "_comp_dequote" to expand the word ([36f158c](https://github.com/scop/bash-completion/commit/36f158cd8743ad83ce773df4a1e3d453a7fb7873))
* **man,info:** remove ineffective "_expand" calls ([57d5392](https://github.com/scop/bash-completion/commit/57d539292d12839e53bb94ed08390256334e9150))
...
* **mutt:** work around "localvar_inherit" ([9c09133](https://github.com/scop/bash-completion/commit/9c0913338f4a93fa645d1366e23d9da95b9ab02b))
* **mysql:** do not generate empty completion for charset ([b88152e](https://github.com/scop/bash-completion/commit/b88152ef61a13b3efd899830b7199b6aa9d2f9ea))
...
* **nounset:** fix nounset errors of -W '${COMPRELY[@]}' ([76b7925](https://github.com/scop/bash-completion/commit/76b7925a5f31f0c24ea3118b0fc4d5a208fa8ece))
* Properly handle environments with unset IFS ([a7aabbc](https://github.com/scop/bash-completion/commit/a7aabbcb13dfbf180a739cfd844cd26966562910))
* **pylint:** `--max-branches` spelling, thanks to `typos ([62b336c](https://github.com/scop/bash-completion/commit/62b336c6e9295a4e4051eba1cc6f9a0b3701cc28))
* **pylint:** make message id completion work with &lt; 2.4.0 ([3896f4f](https://github.com/scop/bash-completion/commit/3896f4f2d707be534c3adf62eb420199aac2298d))
* **pytest:** add "-c file" ([ab7c0b4](https://github.com/scop/bash-completion/commit/ab7c0b4558bc5a020a26907e1ce9870e4ad8513c))
* **python:** nounset mode error with no -X completions ([979062f](https://github.com/scop/bash-completion/commit/979062f10f6835358e873308c4fda6f8c6978ca0))
* **README:** elaborate description of search order ([be0085a](https://github.com/scop/bash-completion/commit/be0085ac8b7b51bd78414588c9da2df1abdb28f3))
* replace all uses of "dequote" with "_comp_dequote" ([2e22a6e](https://github.com/scop/bash-completion/commit/2e22a6e4a60d1d6e5c4593ae7de28c44d50e7c93))
* **reportbug:** avoid interactive mode on help, quote sed pattern ([3f9970d](https://github.com/scop/bash-completion/commit/3f9970daf5c84878cd67576268888cd7d82d14fb))
* **reportbug:** handle the case of prev=-oOPTARG ([6e1ec09](https://github.com/scop/bash-completion/commit/6e1ec098909922bc41eccbe48c24dc5dcfc94822))
* **rsync:** improve completion by using _parse_help ([7e7928d](https://github.com/scop/bash-completion/commit/7e7928d0e8bf2071e09749e4e005a972acf2aa53))
...
* **ssh:** do not complete commands if hostnames haven't been specified ([e29517d](https://github.com/scop/bash-completion/commit/e29517d8597f1cc7bf8c1dac7ac8abcf622f3d32))
* **ssh:** don't confuse arg counting with option args ([72b234a](https://github.com/scop/bash-completion/commit/72b234a3ea2f8f3c8afe9e7e8ce921ef415b405f))
* **tar:** do not associate with *.gem.&lt;compress-extension&gt; ([242e26c](https://github.com/scop/bash-completion/commit/242e26c9e43852d9dddeec444df0ccd997514007))
* **tree:** work around bash-4.2 bug of [[ ${arr[*]} == *text* ]] ([f966e62](https://github.com/scop/bash-completion/commit/f966e6284f5bfec6ece9ff28510021b397ac886f))
* **ulimit:** complete limits only after option that takes one ([ecf6f41](https://github.com/scop/bash-completion/commit/ecf6f41f6109541b0881e3158b80a0726552b545))
* **ulimit:** do not offer soft/hard/unlimited directly after -S or -H ([c18756c](https://github.com/scop/bash-completion/commit/c18756c021c9490aa092be8df7c5cf79c4c78d9b))
* use "_comp_expand_glob" for failglob/nullglob/etc ([5d49f24](https://github.com/scop/bash-completion/commit/5d49f2457fdb5179500f24833e72ab21d519266c))
* variable quoting fixes ([9ba5831](https://github.com/scop/bash-completion/commit/9ba58318d7a00c618c0fad93fdea18a03421a91b))
* **xdg-mime:** actually `cd` to all candidate mime dirs ([f722a8b](https://github.com/scop/bash-completion/commit/f722a8b5289721c92e80bf054cf15132e6ace31b))
* **xdg-mime:** complete only one query type argument ([e02520a](https://github.com/scop/bash-completion/commit/e02520a526ff54f7fec2bd2920181d2f87bbe341))
* **xdg-mime:** mime type array index expansion ([bbe2f09](https://github.com/scop/bash-completion/commit/bbe2f0995b99cebf1c67fb963b67c5e14bb3583d))
* **xdg-mime:** nounset and IFS fixes ([79ca043](https://github.com/scop/bash-completion/commit/79ca043dcd2e240787d6264867fde7b3566acd98))
* **xdg-mime:** trap and cd issues ([4fc5c89](https://github.com/scop/bash-completion/commit/4fc5c89a462d22fdc685af79c8eade8ae476dba4))
* **xmlwf:** try _parse_help before _parse_usage ([af91a70](https://github.com/scop/bash-completion/commit/af91a705b2571934947706ae82e64b32561a19b0))


### Miscellaneous Chores

* tell Release Please to do 2.12.0 next ([1756e9f](https://github.com/scop/bash-completion/commit/1756e9fc73b820dc0171831d28820a27c6bc6f5b))
